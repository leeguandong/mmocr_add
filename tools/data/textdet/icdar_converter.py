...
def load_img_info(files, dataset):
    ...
    for line in gt_list:
        ...
        strs = line.split(',')
        category_id = 1
        xy = [int(float(x)) for x in strs[0:8]]
...
def parse_args():
    ...
    parser.add_argument('--icdar_path', default="/home/ivms/local_disk/tianchi/fintinue", help='icdar root path')
    parser.add_argument('--out-dir', default="/home/ivms/local_disk/tianchi/fintinue", help='output path')
    parser.add_argument('--dataset', default="icdar2015", help='icdar2017 or icdar2015')
    parser.add_argument(
        '--split-list',
        nargs='+',
