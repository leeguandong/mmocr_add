...
# import sys
# sys.path.append("/home/ivms/local_disk/mmocr-main")
import argparse
import os
import warnings
...
def parse_args():
    ...
    parser.add_argument('--config', default="/home/ivms/local_disk/mmocr-main/tools/results/psenet_r50_fpnf_600e_icdar2015.py",
                        help='Test config file path.')
    parser.add_argument('--checkpoint', default="/home/ivms/local_disk/mmocr-main/tools/results/epoch_600.pth", help='Checkpoint file.')
    parser.add_argument('--out', default="/home/ivms/local_disk/mmocr-main/results/result.pkl", help='Output result file in pickle format.')
    parser.add_argument(
        '--fuse-conv-bn',
        action='store_true',
