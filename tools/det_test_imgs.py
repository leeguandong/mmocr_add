...
def main():
    ...
    parser.add_argument('--img_root',
                        default='/home/ivms/local_disk/tianchi/fintinue/imgs/test', type=str, help='Image root path')
    parser.add_argument('--img_list',
                        default='/home/ivms/local_disk/tianchi/fintinue/imgs/test.txt', type=str, help='Image path list file')
    parser.add_argument('--config',
                        default='/home/ivms/local_disk/mmocr-main/tools/results/dbnet_r18_fpnc_1200e_icdar2015.py', type=str,
                        help='Config file')
    parser.add_argument('--checkpoint',
                        default='/home/ivms/local_disk/mmocr-main/tools/results/epoch_1200.pth', type=str,
